...
if st.sidebar.button("Send Transaction"):
    # Calculate the gas price you want to set, which should be greater than or equal to the baseFeePerGas
    gas_price = 875000000  # You can set this value to be equal or greater than the baseFeePerGas
    # Calculate the nonce
    ...
    try:
        # Create the transaction object with nonce
        transaction = {
            "to": candidate_address,
            "value": w3.toWei(wage, "ether"),
            "gas": 21000,  # A typical gas limit for a simple transaction
            "gasPrice": gas_price,  # Set the gas price to the value you defined
            "nonce": nonce  # Add the nonce to the transaction
        }
